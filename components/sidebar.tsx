...
import { BookOpen, Heart, Home, Menu, Search, ShieldCheck, UserRound, X } from "lucide-react";
...
export default function Sidebar() {
  ...
  return <>
    ...
    <aside className="sidebar" style={open ? {transform:"translateX(0)"} : undefined}>
      <Link href="/" className="brand" onClick={() => setOpen(false)}><span className="brand-mark">B</span><span><strong>Bickri Lib</strong><small>Bibliothèque intelligente</small></span></Link>
